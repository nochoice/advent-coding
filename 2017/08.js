...
addToRegisters = (reg) => {
    register[reg] = register[reg] || 0; 
}

prepareRegisterCondition = (condition) => {
    if(isNaN(condition[1])) {
        addToRegisters(condition[1]); 
        condition[1] = `register['${condition[1]}']`;
    }
    if(isNaN(condition[3])) {
        addToRegisters(condition[3]); 
        condition[3] = `register['${condition[3]}']`;
    }
